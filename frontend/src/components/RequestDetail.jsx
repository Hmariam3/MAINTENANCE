...
const RequestDetail = () => {
  ...
  const canApproveClosure = [ROLES.SUPERVISOR, ROLES.MANAGER, ROLES.DIRECTOR].includes(roleId) && request.status_id === STATUS.COMPLETED && !request.user_approved_closure_at;
  ...
  return (
    <div style={{ maxWidth:'1000px', margin:'0 auto', paddingBottom:'3rem' }}>
      ...
      {/* ── Toast ──────────────────────────────────────────────────────────── */}
      {toast && (
        <div style={{ marginBottom:'1rem', padding:'0.85rem 1rem', borderRadius:'8px', fontSize:'0.875rem', fontWeight:'500',
          ...
          {STEPS.map((step, i) => {
            ...
            return (
              <div key={i} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:'0.4rem', zIndex:2 }}>
                <div style={{ width:'38px', height:'38px', borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center', fontSize: done ? '1rem' : '0.85rem',
